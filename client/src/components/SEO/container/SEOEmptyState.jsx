...
const SEOEmptyState = ({ 
  ...
  return (
    <div className="text-center py-10">
      ...
      <h3 className="mt-2 text-sm font-semibold text-gray-800 dark:text-gray-200">No hay configuraciones SEO</h3>
      <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
        {searchQuery ? 'No se encontraron resultados para tu búsqueda.' : 'Comienza creando una nueva configuración.'}
      </p>
      <div className="mt-6">
        <button
          type="button"
